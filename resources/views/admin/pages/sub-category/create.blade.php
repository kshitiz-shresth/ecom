                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('sub-category.store') }}" method="POST">
                                        ...
                                        <button class="btn btn-success" name="submit" value="0" type="submit">Submit And Add More</button>
                                        <button class="btn btn-success" name="submit" value="1" type="submit">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
